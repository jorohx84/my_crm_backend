...
from .views import CreateTaskView, TaskListView, SingleTaskView, CreateCommentView, CommentUpdateView, SubtaskCreatetView, SubtaskListView
...
urlpatterns = [
    ...
    path('subtasks/<int:task_id>/', SubtaskListView.as_view(), name="subtask-list"),
]
